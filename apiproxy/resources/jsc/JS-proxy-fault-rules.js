...
switch(faultName) {
    ...
    case "InvalidApiKey" :
        ...
        reasonPhrase = "Unauthorized";
        code = "401.005";
        description = "Invalid X-APIKey in header";
        break;
    ...
    case "RaiseFault" :
        if ( context.getVariable("raisefault.RF-invalid-client-cn.failed") === true ) {
            ...
            var clientCNs = context.getVariable("private.flow.client.cns");
            description = "Invalid Client CN " + description + "'" + clientCN + "'" + " not in whitelist " + "'" + clientCNs + "'";
